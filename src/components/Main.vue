  ...
  <main class="w-full flex flex-wrap flex-col justify-center items-center">
    <section class="flex-1 mt-12 2xl:mb-96 xl:mb-20 mb-16 relative w-full">
      <div class="flex justify-center flex-wrap">
        <div class="relative flex-1 2xl:max-w-7xl lg:max-w-5xl md:max-w-2xl sm:max-w-xl max-w-lg mx-3">
            <TransitionGroup v-viewer tag="div" name="list" class="flex flex-row justify-center items-start flex-wrap gap-3">
              ...
              <img  v-for="d in dogs" :key="d.id" alt=""  
                ...
                class="bg-[#85586F] 2xl:w-52 2xl:h-52 xl:w-48 xl:h-48 lg:w-48 lg:h-48 md:w-46 md:h-48 sm:w-48 sm:h-48 w-28 h-28  object-cover rounded-md cursor-pointer transition ease-in-out hover:scale-105 duration-500 hover:shadow-xl">
